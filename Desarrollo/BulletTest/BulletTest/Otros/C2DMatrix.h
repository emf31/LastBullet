...
public:
	...
	inline void  Rotate(const Vec2f &fwd, const Vec2f &side);

	//applys a transformation matrix to a std::vector of points
	inline void TransformVec2fs(std::vector<Vec2f> &vPoints);

	//applys a transformation matrix to a point
	inline void TransformVec2fs(Vec2f &vPoint);
...
//applies a 2D transformation matrix to a std::vector of Vec2fs
inline void C2DMatrix::TransformVec2fs(std::vector<Vec2f> &vPoint)
{
...
//applies a 2D transformation matrix to a single Vec2f
inline void C2DMatrix::TransformVec2fs(Vec2f &vPoint)
{
...
inline void C2DMatrix::Rotate(const Vec2f &fwd, const Vec2f &side)
{
	C2DMatrix::Matrix mat;
