...
protected:
	...
	//Singleton design added 2007.11
	MastEventReceiver(MastEventReceiver const&);
	MastEventReceiver() { init(); }
...
public:
	...
	//Singleton design added 2007.11
	static MastEventReceiver& i() {
		static MastEventReceiver singleton;
		return singleton;
	}
