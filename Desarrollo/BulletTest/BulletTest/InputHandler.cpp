...
InputHandler::InputHandler(Command& space, Command& move, Command& shoot):ButtonSpace(space),ButtonMove(move), ButtonShoot(shoot)
{
...
void InputHandler::handleInput(){
	...
	if (MastEventReceiver::i().leftMousePressed()) {
		ButtonShoot.execute();
	}
