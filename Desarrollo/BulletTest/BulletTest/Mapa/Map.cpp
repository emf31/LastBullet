...
bool Map::isPathObstructed(Vec2f posIni, Vec2f posFinal, float radio)
{
	...
	btCollisionWorld::ClosestRayResultCallback ray1(start1, end1);

	PhysicsEngine::i().m_world->rayTest(start1, end1, ray1);
	...
	btCollisionWorld::ClosestRayResultCallback ray2(start2, end2);

	PhysicsEngine::i().m_world->rayTest(start2, end2, ray2);
