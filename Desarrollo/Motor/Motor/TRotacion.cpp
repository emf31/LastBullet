...
void TRotacion::transpose() {
	m_matrix = glm::transpose(m_matrix);
}

void TRotacion::invert() {
	m_matrix = glm::inverse(m_matrix);
}

void TRotacion::setRotation(Vec3<float> rotation) {
...
void TRotacion::setRotation2(float angu, Vec3<float> rotation)
{
...
*/
Vec3<float> TRotacion::getRotation() {
	return Vec3<float>(m_rotation.x, m_rotation.y, m_rotation.z);
}

void TRotacion::multiply(glm::mat4 mat) {
	m_matrix = m_matrix * mat;
}

void TRotacion::multiply(glm::vec4 vec) {
	//m_matrix = vec * m_matrix ;
	//TODO

}

void TRotacion::loadMatrix(glm::mat4 mat) {
	m_matrix = mat;
}

void TRotacion::beginDraw(glm::mat4 projection, glm::mat4 view, glm::mat4& matrizActual)
{
...
void TRotacion::endDraw(glm::mat4& matrizActual)
{
